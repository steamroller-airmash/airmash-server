...
# TODO: rev-eng or determine if is MobType
enum MobUpdateType : u8 {

}

# TODO: rev-eng or determine if is MobType
enum MobDespawnType : u8 {
...
spec server {
  ...
  # [`Command`](client/struct.command.html).
	...
	PlayerFire {
		...
		projectiles:  SmallArray[PlayerFireProjectile]
	}
  ...
  # (tab) menu in FFA.
	...
	ScoreDetailedFFA {
		scores: Array[ScoreDetailedFFAScore]
	}
	...
	ScoreDetailedCTF {
		scores: Array[ScoreDetailedCTFScore]
	}
