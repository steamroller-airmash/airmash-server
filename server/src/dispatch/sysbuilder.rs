...
pub trait AbstractBuilder {
	fn build<'a, 'b>(self, disp: DispatcherBuilder<'a, 'b>)
		-> DispatcherBuilder<'a, 'b>;

	fn build_thread_local<'a, 'b>(self, disp: DispatcherBuilder<'a, 'b>)
		-> DispatcherBuilder<'a, 'b>;
}
		...
		for<'d> <T as System<'d>>::SystemData: SystemData<'d>
{
	...
	fn build_thread_local<'a, 'b>(self, disp: DispatcherBuilder<'a, 'b>) -> DispatcherBuilder<'a, 'b> {
